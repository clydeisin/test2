! function() {
    ...
    const e = e => {
        ...
        return [1 == l ? o ? ? a : "object" == typeof r ? "object" == typeof r.d ? r.d ? .v ? ? o ? ? a : r.d ? ? o ? ? a : r ? ? o ? ? a, "object" == typeof r ? "object" == typeof r.d ? r.d ? .v ? ? a : r.d ? ? a : r ? ? a, "object" == typeof r ? "object" == typeof r.n ? _tpt.tf(r.n ? .e ? ? !1) || !t ? r.n ? .v ? ? a : i : r.n ? ? a : r ? ? a, "object" == typeof r ? "object" == typeof r.t ? _tpt.tf(r.t ? .e ? ? !1) || !t ? r.t ? .v ? ? a : i : r.t ? ? a : r ? ? a, "object" == typeof r ? "object" == typeof r.m ? _tpt.tf(r.m ? .e ? ? !1) || !t ? r.m ? .v ? ? a : i : r.m ? ? a : r ? ? a]
    };
    SR7.migrate.stgTrans = {
        random: "random",
        edge: "edges",
        edges: "edges",
        edgetomiddle: "edges",
        ...
        let r = {
            ...
            size: {
                ...
                height: _tpt.DNTMtoArr(e.size ? .height),
                width: _tpt.DNTMtoArr(e.size ? .width),
                cachedHeight: _tpt.DNTMtoArr(e.size ? .editorCache, 0),
                ...
                minHeight: "fullwidth" !== e.layouttype && "fullscreen" !== e.layouttype ? void 0 !== e.size && void 0 !== e.size.minHeight ? _tpt.DNTMtoArr(e.size.minHeight) : void 0 : "fullscreen" === e.layouttype && void 0 !== e.size && void 0 !== e.size.minHeightFullScreen ? _tpt.DNTMtoArr(e.size.minHeightFullScreen) : void 0,
                maxHeight: void 0 !== e.size && void 0 !== e.size.maxHeight ? _tpt.DNTMtoArr(e.size.maxHeight) : void 0,
            ...
            vPort: e.general ? .slideshow ? .viewPort ? _tpt.DNTMtoArr(e.general ? .slideshow ? .viewPortArea ? ? "-100px") : e.general ? .slideshow ? .globalViewPort ? _tpt.DNTMtoArr(e.general ? .slideshow ? .globalViewDist ? ? "-100px") : ["-100px", "-100px", "-100px", "-100px", "-100px"],
            snap: {
            ...
            general: {
                ...
                fallbackType: e.troubleshooting ? .alternateImageType ? ? "off"
            },
            browser: {
            ...
            nav: {
                acc: {
                    hidden: e.nav ? .acc ? .hidden ? ? !0,
                    pressed: e.nav ? .acc ? .pressed ? ? "unset",
                    next: e.nav ? .acc ? .next ? ? "Next Slide",
                    prev: e.nav ? .acc ? .prev ? ? "Previous Slide",
                    tab: e.nav ? .acc ? .tab ? ? "Tab",
                    thumb: e.nav ? .acc ? .thumb ? ? "Thumbnail",
                    bullet: e.nav ? .acc ? .bullet ? ? "Bullet"
                },
                m: {
        ...
        for (let t of ["tabs", "thumbs"])
            if (e.nav ? .[t] ? .set) {
                ...
                let d = e.nav[t] ? .padding ? ? 5,
                    ...
                    c = parseInt(e.nav[t] ? .height ? ? 100),
                    m = Math.min(p, parseInt(e.nav[t] ? .widthMin ? ? p)),
                    f = p - m,
                    u = [p, p, Math.round(p - (f - f / 760 * 544)), Math.round(p - (f - f / 760 * 298)), parseInt(e.nav[t] ? .widthMin ? ? 50)],
                    g = [c, c, Math.round(u[2] / u[0] * c), Math.round(u[3] / u[0] * c), Math.round(u[4] / u[0] * c)];
                void 0 !== a && (r.nav[t] = {
                    set: !0,
                    def: a.placeholders,
                    key: a.handle,
    ...
    const t = (e = "") => e && e.endsWith("#") && e.length > 3 && "/" == e[e.length - 2] ? "" : e;

    function r(e) {
        for (let t in e) "string" == typeof e[t] ? e[t] = e[t].replaceAll("|", ",") : "object" == typeof e[t] && null !== e[t] && r(e[t])
    }
    SR7.migrate.slideObj = function(e) {
        var r = e.params ? ? {};
        r.global = r.static;
        var o = e.global ? {
            global: !0,
            respVP: !0,
            id: SR7.D.fixSR6IDs(e.id ? ? r.id, !0),
            title: e.title ? ? r.title ? ? "",
            parentID: SR7.D.fixSR6IDs(r.child ? .parentId ? ? null, !0),
            language: r.child ? .language ? ? "default",
            oflow: r.global ? .overflow ? ? !1,
            pos: r.global ? .position ? ? "front",
            fullHeight: !0
        } : {
            id: SR7.D.fixSR6IDs(e.id ? ? r.id),
            order: e.order ? ? void 0,
            title: e.title ? ? r.title ? ? "",
            parentID: SR7.D.fixSR6IDs(r.child ? .parentId ? ? null),
            language: r.child ? .language ? ? "default",
            acc: {
                label: r.acc ? .label ? ? "unset",
                hidden: r.acc ? .hidden ? ? "true",
                live: r.acc ? .live ? ? "auto",
                role: r.acc ? .role ? ? "presentation",
                roledep: r.acc ? .roledep ? ? "slide"
            },
            thumb: {
                src: t(r.thumb ? .customThumbSrc ? ? ""),
                srcId: r.thumb ? .customThumbSrcId ? ? "",
                admin: t(r.thumb ? .customAdminThumbSrc ? ? ""),
                adminId: r.thumb ? .customAdminThumbSrcId ? ? "",
                dimension: r.thumb ? .dimension ? ? "slider",
                default: i(r.bg, r.media, "gallery", !0)
            },
            params: r.info ? .params ? ? void 0,
            description: r.info ? .description ? ? "",
            attr: {
                class: r.attributes ? .class ? ? "",
                data: r.attributes ? .data ? ? "",
                id: r.attributes ? .id ? ? "",
                a: r.attributes ? .alt ? ? "",
                aO: a(r.attributes ? .altOption ? ? "media_library"),
                deepLink: r.attributes ? .deeplink ? ? "",
                attr: r.attributes ? .attr ? ? ""
            },
            publish: {
                from: r.publish ? .from ? ? "",
                to: r.publish ? .to ? ? "",
                state: r.publish ? .state ? ? ""
            },
            slideshow: {
                stop: _tpt.tf(r.timeline ? .stopOnPurpose ? ? !1),
                len: "" == (r.timeline ? .delay ? ? "default") ? "default" : r.timeline ? .delay ? ? "default",
                hal: r.visibility ? .hideAfterLoop ? ? 0,
                hom: _tpt.tf(r.visibility ? .hideOnMobile ? ? !1),
                hfn: _tpt.tf(r.visibility ? .hideFromNavigation ? ? !1)
            }
        };
        if (void 0 !== r.nav || void 0 !== o.nav)
            for (let e of ["tabs", "thumbs", "arrows", "bullets"])
                if (r.nav ? .[e] ? .presets)
                    for (let t in r.nav[e].presets) _tpt.hop(r.nav[e].presets, t) && !t.includes("-def") && r.nav[e].presets[t + "-def"] && (o.nav ? ? = {}, o.nav[e] ? ? = {}, o.nav[e][t] = r.nav[e].presets[t]);
        (SR7.E.backend || r ? .timeline ? .loop ? .set) && (o.loop = {
            u: r.timeline ? .loop ? .set ? ? !1,
            r: r.timeline ? .loop ? .repeat ? ? -1,
            s: r.timeline ? .loop ? .start ? ? 0,
            e: r.timeline ? .loop ? .end ? ? 4500
        }), (SR7.E.backend || void 0 !== r.addOns) && (o.addOns = {});
        for (let e in r.addOns) {
            if (!_tpt.hop(r.addOns, e)) continue;
            let t = e.replace("revslider-", "").replace("-addon", ""),
                a = SR7.migrate.Addon("slide", r.addOns[e], t);
            void 0 !== a && (o.addOns[t] = a)
        }
        return o
    };
    const a = e => "media_library" == e ? "ml" : "file_name" == e ? "fn" : "c",
        i = (e, t, r, a) => {
            let i;
            return null == e ? {
                color: "transparent"
    ...
    SR7.migrate.SlideBG = function(e, t, o, l, s = "Slide BG Layer", n = "shape", d = "slidebg") {
        ...
        var c = {
            ...
            pos: {
                h: _tpt.DNTMtoArr("center"),
                v: _tpt.DNTMtoArr("center"),
                pos: e.position ? .position ? ? "absolute"
            },
            display: _tpt.DNTMtoArr("block"),
        ...
        if (e.attributes && (c.attr = {
                a: e.attributes ? .alt ? ? "",
                aO: a(e.attributes ? .altOption ? ? "media_library"),
                t: e.attributes ? .title ? ? "",
                tO: a(e.attributes ? .titleOption ? ? "media_library")
            }), e.seo ? .set && "front" !== (e.seo ? .z ? ? "front") && (e.actions = SR7.migrate.getSEOSlideAction(e.seo), c = SR7.migrate.action(e, c, l, t), "jquery" != e.actions.action[0].link_type && "regular" === e.actions.action[0].type || (c.cursor = "pointer")), null == e.slideChange && !c.tl ? .in ? .bg ? .rnd) {
            ...
            c.tl.in.bg.ms = "default" == t ? c.tl.in.bg.ms : t, c.tl.in.bg.in.e = "default" == r ? c.tl.in.bg.in.e : r, c.tl.in.bg.out.e = "default" == a ? c.tl.in.bg.out.e : a
        }
        return void 0 !== e.bg && (c.bg = i(e.bg, e.media, o), "none" !== (e.bg ? .video ? .dotted ? ? e.bg ? .video ? .dottedOverlay ? ? "none") && (c.overlay = {
        ...
        })), e.panzoom ? .set && "image" == e.bg.type && (c.tl ? ? = {}, c.tl.in ? ? = {}, c.tl.in.pan = {
            all: [{
        ...
        }, (e.panzoom.blurStart || e.panzoom.blurEnd) && (c.tl.in.filter = {
            all: [{
                fu: !0,
    ...
    SR7.migrate.translateEase = e => {
            ...
            if ("layer" == e) switch (r) {
                ...
                if ("slide_new_layers" == e) {
                    ...
                    switch (r) {
                        case "beforeafter":
                            if (!t ? .enable) return;
                            return e = SR7.migrate.SlideBG(t, a, "gallery", i, "BeforeAfter After BG", "shape", ""), e.addOns = {
                                beforeafter: {
                                    p: "after"
                                }
                            }, e;
    ...
    }, SR7.migrate.LayerObj = function(t) {
        let {
            dLEN: r,
            o: i = {},
            newIDs: o,
        ...
        var d = i.group ? .puid ? ? ("row" == i.type ? "top" : -1);
        i.uid;
        i.uid = o[i.uid] || i.uid, d = o[d] || d;
        let p = i.type;
        i.type = i.linebreak ? "linebreak" : "row" == i.type || "group" == i.type || "column" == i.type || "zone" == i.type ? "container" : "button" == i.type || "text" == i.type ? "text" : i.type ? ? "text", i.runtime ? .internalClass && (i.runtime.internalClass = i.runtime.internalClass.replaceAll("rev-b-span", "sr7").replaceAll("rev-burger", "sr7-brg").replaceAll("rev-button", "sr7-btn").replaceAll("rev-", "sr7-").replaceAll("revb-", "sr7-")), i = ((e, t) => {
            try {
        ...
        let c = "zone" == p ? i.position ? .zIndex ? ? i.group ? .groupOrder ? ? -1 : i.position ? .zIndex ? ? void 0;
        c = "zone" == p ? c < 1 ? -1 : c + 1 : c;
        let m = i ? .behavior ? .intelligentInherit ? ? !0,
            f = {
                w: "column" == p || "row" == p ? new Array(5).fill("auto") : e({
                    BII: m,
                    o: i.size ? .width ? ? "auto",
                    def: "fullwidth" == (i.size ? .covermode ? ? "") ? "100%" : "auto",
                    lgdef: "#a"
                }),
                h: "column" == p || "row" == p ? new Array(5).fill("auto") : e({
                    BII: m,
                    o: i.size ? .height ? ? "auto",
                    def: "fullheight" == (i.size ? .covermode ? ? "") ? "100%" : "auto",
                    lgdef: "#a"
                }),
                maxW: e({
                    BII: m,
                    o: i.size ? .maxWidth ? ? "none",
                    def: "none",
                    rdef: "none",
                    lgdef: "none"
                }),
                ...
                minH: e({
                    BII: m,
                    o: i.size ? .minHeight ? ? "none",
                    def: "none",
                    rdef: "none",
                    lgdef: "none"
                }),
                oW: i.size ? .originalWidth ? ? void 0,
                oH: i.size ? .originalHeight ? ? void 0,
                aRatio: e({
                    BII: m,
                    o: i.size ? .aspectRatio ? ? "auto",
                    def: "auto",
                    rdef: "auto",
                    lgdef: "auto"
                }),
                cMode: i.size ? .covermode ? ? "custom",
                sProp: i.size ? .scaleProportional ? ? ("image" == i.type || "svg" == i.type || "video" == i.type)
            },
            u = {
                x: e({
                    BII: m,
                ...
                h: _tpt.DNTMtoArr(i.position ? .horizontal ? ? "left", "left"),
                v: _tpt.DNTMtoArr("zone" == p ? i.alias.toLowerCase().replace(" rows", "") : i.position ? .vertical ? ? "top", "zone" == p ? i.alias.toLowerCase().replace(" rows", "") : "top"),
                pos: i.position ? .position ? ? void 0,
                float: _tpt.DNTMtoArr(i.idle ? .float ? ? "none", "none"),
                clear: _tpt.DNTMtoArr(i.idle ? .clear ? ? "none", "none")
            };
        var g = {
            rTo: i.behavior ? .baseAlign ? ? ("zone" == p ? "slide" : ""),
            fluid: {
                tx: i.behavior ? .autoResponsive ? ? !0,
                tr: i.behavior ? .autoResponsive ? ? !0,
                sp: "row" != p && "column" != p && (i.behavior ? .responsiveOffset ? ? !0)
            },
            id: i.uid ? ? "",
            alias: i.alias ? ? "",
            type: i.type,
            subtype: "row" == p || "column" == p || "group" == p | "zone" == p ? p : "button" == p ? "button" : i.subtype ? ? "",
            content: "text" == i.type || "button" == i.type ? SR7.D.contentOBJ("text", {
                text: i.text ? ? "",
                ph: i.placeholder ? ? "",
                deco: i.idle ? .textDecoration ? ? "none",
                trans: i.idle ? .textTransform ? ? "none"
            }) : "image" == i.type ? SR7.D.contentOBJ("image", {
                src: i.media ? .imageUrl,
                lib: i.media ? .imageLib ? ? "",
                lib_id: i.media ? .imageId,
                fromStream: i.media ? .imageFromStream,
                streamType: s ? ? "gallery",
                size: void 0 === i.size ? .covermode ? "100% 100%" : "cover-proportional" == i.size ? .covermode || "cover" == i.size ? .covermode || i.size.originalWidth && i.size.originalHeight && 1e3 * Math.round(i.size.originalWidth / i.size.originalHeight) / 1e3 != Math.round(parseInt(i.size ? .width ? .d ? .v ? ? 1) / parseInt(i.size ? .height ? .d ? .v ? ? 1) * 1e3) / 1e3 ? "cover" : "contain"
            }) : "svg" == i.type ? SR7.D.contentOBJ(i.type, {
                full: i.svg,
                src: i.svg ? .source,
                oC: i.idle ? .svg ? .originalColor ? ? !1,
                color: _tpt.DNTMtoArr(i.idle ? .svg ? .color ? ? "#ffffff", "#ffffff"),
                all: i.idle ? .svg ? .styleAll ? ? !1,
                stroke: {
                    c: i.idle ? .svg ? .strokeColor ? ? "transparent",
                    d: i.idle ? .svg ? .strokeDashArray ? ? 0,
                    o: i.idle ? .svg ? .strokeDashOffset ? ? 0,
                    w: i.idle ? .svg ? .strokeWidth ? ? 0
                }
            }) : "video" == i.type || "audio" == i.type ? SR7.D.contentOBJ(i.type, {
                type: (i.media ? .mediaType ? ? "html5").replace("stream", ""),
                src: "audio" == i.type ? i.media ? .audioUrl ? ? "" : "html5" == (i.media ? .mediaType ? ? "html5").toLowerCase() ? i.media ? .mp4Url ? ? "" : i.media ? .id ? ? "A",
                controls: 1 == (i.media ? .controls ? ? !1) ? 1 == (i.media ? .largeControls ? ? !0) ? "s+xl" : "s" : 0 == (i.media ? .largeControls ? ? !0) ? "none" : "xl",
                autoPlay: i.media ? .autoPlay ? ? !0,
                pauseTimer: i.media ? .pausetimer ? ? !1,
                start: i.media ? .startAt ? ? "",
                end: i.media ? .endAt ? ? "",
                nextSlide: i.media ? .nextSlideAtEnd ? ? !0,
                stopAllMedia: i.media ? .stopAllVideo ? ? !0,
                loop: i.media ? .loop ? ? !0,
                preload: i.media ? .preload ? ? "auto",
                preloadWait: i.media ? .preloadWait ? ? "0",
                rewind: i.media ? .forceRewind ? ? !0,
                volume: i.media ? .volume ? ? "100",
                poster: {
                    src: i.media ? .posterUrl ? ? i.media ? .thumbs ? .veryBig ? .url ? ? "",
                    lib: i.media ? .imageLib ? ? "",
                    lib_id: i.media ? .posterId ? ? "",
                    lib_size: i.behavior ? .imageSourceType ? ? "full",
                    fromStream: (i.media ? .poster ? .posterFromStream ? ? !1) || (i.media.posterFromStream ? ? !1),
                    showOnPause: i.media ? .posterOnPause,
                    insteadVideo: i.media ? .posterOnMobile ? ? !1,
                    noOnMobile: i.media ? .disableOnMobile ? ? !1
                },
                fromStream: !(null != (i.media ? .videoFromStream ? ? void 0) || !(i.media ? .mediaType ? ? "").includes("stream")) || (i.media ? .videoFromStream ? ? !1),
                streamType: s.type ? ? "gallery",
                noInteract: i.media ? .nointeraction ? ? !1,
                cover: !!(i.media ? .fitCover ? ? "html5" == (i.media ? .mediaType ? ? "html5").toLowerCase()) || ("cover-proportional" == i.size ? .covermode || "cover" == i.size ? .covermode),
                aFullScreen: i.media ? .allowFullscreen ? ? !0,
                args: i.media ? .args ? ? "",
                fullWidth: i.media ? .fullWidth ? ? !1,
                mute: i.media ? .mute ? ? "true" === String(i.media ? .autoPlay),
                ratio: i.media ? .ratio ? ? "16:9",
                inline: i.media ? .playInline ? ? !0,
                speed: i.media ? .speed ? ? 1,
                pauseOnSwap: i.media ? .pauseOnSlideChange ? ? !1,
                cOC: i.media ? .keepOnCarousel ? ? !1
            }) : {},
            tag: i.htmltag ? ? "sr7-layer",
            blend: i.idle ? .filter ? .blendMode ? ? "normal",
            codes: {
                css: i.customCSS ? ? "",
                hovercss: i.customHoverCSS ? ? ""
            },
            libSrc: i.layerLibSrc ? ? "",
            size: f,
            pos: u,
            pid: d,
            zIndex: c,
            order: i.group ? .groupOrder ? ? void 0,
            attr: {
                a: i.attributes ? .alt ? ? "",
                aO: a(i.attributes ? .altOption ? ? "media_library"),
                id: i.attributes ? .id ? ? void 0,
                iClass: i.runtime ? .internalClass ? ? "",
                class: i.attributes ? .classes ? ? "",
                rel: i.attributes ? .rel ? ? "",
                tabIndex: i.attributes ? .tabIndex ? ? 0,
                t: i.attributes ? .title ? ? "",
                tO: a(i.attributes ? .titleOption ? ? "media_library"),
                wrapClass: i.attributes ? .wrapperClasses ? ? "",
                wrapId: i.attributes ? .wrapperId ? ? ""
            },
            acc: {
                hidden: i.acc ? .hidden ? ? "true",
                label: i.acc ? .label ? ? "",
                labeledby: i.acc ? .labeledby ? ? "",
                role: i.acc ? .role ? ? "",
                haspopup: i.acc ? .haspopup ? ? "false"
            },
            runtime: {
                locked: i.visibility ? .locked ? ? !1,
                hidden: !(i.visibility ? .visible ? ? 1)
            },
            style: i.idle ? .style ? ? "",
            display: "absolute" == i.position ? .position && "shape" == i.type && -1 == d ? ["block", "block", "block", "block", "block"] : i.idle ? .display ? ? ["block", "block", "block", "block", "block"],
            tA: _tpt.DNTMtoArr(i.idle ? .textAlign ? ? "left", "left"),
            vA: i.idle ? .verticalAlign ? ? "top",
            oflow: i.idle ? .overflow ? ? "visible",
            cursor: i.idle ? .cursor ? ? "cursor",
            pE: i ? .hover ? .pointerEvents ? ? "auto",
            uS: "default",
            bg: {
                color: _tpt.gradient.convert(i.idle ? .backgroundColor ? ? "transparent"),
                image: SR7.D.contentOBJ("image", {
                    src: i.idle ? .backgroundImage ? ? "",
                    lib: i.idle ? .imageLib ? ? "",
                    lib_id: i.idle ? .backgroundImageId ? ? "",
                    fromStream: i.idle ? .bgFromStream ? ? !1,
                    pos: SR7.D.convertBGPosObj(i.idle ? .backgroundPosition ? ? "50% 50%"),
                    repeat: i.idle ? .backgroundRepeat ? ? "no-repeat",
                    size: i.idle ? .backgroundSize ? ? "cover",
                    sizeVal: i.idle && "percentage" == i.idle.backgroundSize ? parseInt(i.idle ? .backgroundSizePerc ? ? 100) + "%" : i.idle && "pixel" == i.idle.backgroundSize ? parseInt(i.idle ? .backgroundSizePix ? ? i.idle ? .backgroundSizePerc ? ? 100) + "px" : 0
                }),
                bClip: i.idle ? .backgroundClip ? ? "none",
                tFCol: i.idle ? .textFillColor ? ? "none"
            },
            px: {
                use: i.effects ? .parallax ? ? !1,
                time: i.timeline ? .scrollBased ? ? "default",
                so: i.timeline ? .scrollBasedOffset ? ? "0ms",
                eff: i.effects ? .effect ? ? "default",
                aBG: "false" == String(i.effects ? .parallax ? ? !1) && (i.effects ? .attachToBg ? ? !1),
                m: i.effects ? .pxmask ? ? !1
            }
        };
        (SR7.E.backend || void 0 !== i.visibility) && (g.vis = _tpt.DNTMtoArr(i.visibility ? ? !0, !0)), (SR7.E.backend || void 0 !== i.visibility) && (g.viSH = i.visibility.onlyOnSlideHover ? ? !1), (SR7.E.backend || void 0 !== i.visibility) && (g.viOC = i.visibility.alwaysOnCarousel ? ? !1), (SR7.E.backend || void 0 !== i.addOns) && (g.addOns = {});
        for (let e in i.addOns) {
            if (!_tpt.hop(i.addOns, e)) continue;
            let t = e.replace("revslider-", "").replace("-addon", ""),
                r = SR7.migrate.Addon("layer", i.addOns[e], t);
            void 0 !== r && (g.addOns[t] = r)
        }
        "row" == p && (g.break = SR7.D.olevels[i.group.columnbreakat ? ? "tablet"]), "column" == p && (g.size.col = i.group ? .columnSize ? ? "1/3");
        var v, b = ["d", "d", "n", "t", "m"];
        if ((SR7.E.backend || i.idle ? .rotationX && 0 !== i.idle.rotationX) && (g.tr = g.tr || {}) && (g.tr.rX = i.idle ? .rotationX || 0), (SR7.E.backend || i.idle ? .rotationY && 0 !== i.idle.rotationY) && (g.tr = g.tr || {}) && (g.tr.rY = i.idle ? .rotationY || 0), (SR7.E.backend || i.idle ? .rotationZ && 0 !== i.idle.rotationZ) && (g.tr = g.tr || {}) && (g.tr.rZ = i.idle ? .rotationZ || 0), (SR7.E.backend || i.idle ? .opacity && 0 !== i.idle.opacity) && (g.tr = g.tr || {}) && (g.tr.o = i.idle ? .opacity || 0), (SR7.E.backend || g.tr) && (g.tr.fix = i.idle ? .filtersIOSFix || "d"), "none" !== (i.media ? .dotted ? ? "none") && (g.overlay = {
                type: i.media.dotted ? ? "none",
                size: i.media.dottedSize ? ? 1,
                cA: i.media.dottedColorA ? ? "transparent",
                cB: i.media.dottedColorB ? ? "#000000"
            }), (n || void 0 !== (i.timeline ? .static ? .start ? ? void 0)) && (g.sStart = i.timeline ? .static ? .start ? ? 1), (n || void 0 !== (i.timeline ? .static ? .end ? ? void 0)) && (g.sEnd = i.timeline ? .static ? .end ? ? "last"), (n || void 0 !== (i.position ? .staticZ ? ? void 0)) && (g.sZ = i.position.staticZ), void 0 !== i.idle) {
            if (void 0 !== i.idle.borderStyle) {
                var y = !1;
                for (v = 1; v < 5; v++) y = y || "none" !== i.idle.borderStyle[b[v]] ? .v && void 0 !== i.idle.borderStyle[b[v]] ? .v;
                if (y)
                    for (g.border = {
                            s: Array(5),
                            c: i.idle.borderColor,
                            w: {
                                t: _tpt.DNTMtoArr(i.idle.borderWidth ? .[0] ? ? 0, 0, "#a"),
                                r: _tpt.DNTMtoArr(i.idle.borderWidth ? .[1] ? ? 0, 0, "#a"),
                                b: _tpt.DNTMtoArr(i.idle.borderWidth ? .[2] ? ? 0, 0, "#a"),
                                l: _tpt.DNTMtoArr(i.idle.borderWidth ? .[3] ? ? 0, 0, "#a")
                            }
                        }, v = 0; v < 5; v++) g.border.s[v] = i.idle.borderStyle[b[v]] ? .v
            }
            if (void 0 !== i.idle.borderRadius) {
                for (y = !1, v = 0; v < 4; v++) y = y || 0 !== i.idle.borderRadius[v] ? .v;
                y && (g.radius = {
                    t: i.idle.borderRadius.v ? .[0] ? ? 0,
                    r: i.idle.borderRadius.v ? .[1] ? ? 0,
                    b: i.idle.borderRadius.v ? .[2] ? ? 0,
                    l: i.idle.borderRadius.v ? .[3] ? ? 0
                })
            }
        }
        if ("text" == g.type || "row" == g.subType || "column" == g.subType)
            for (g.ws = Array(5), v = 0; v < 5; v++) g.ws[v] = i.idle ? .whiteSpace ? .[b[v]] ? .v ? ? ("text" == g.type ? "nowrap" : "normal");
        for (v = 0; v < 5; v++) {
            var h = 0;
            for (var S of (g.m ? ? = {}, g.p ? ? = {}, ["t", "r", "b", "l"])) {
                g.m[S] ? ? = Array(5), g.p[S] ? ? = Array(5);
                let e = i.idle ? .margin ? .[b[v]] ? .v ? .[h],
                    t = i.idle ? .margin ? .[b[v]] ? .e ? ? !1,
                    r = i.idle ? .padding ? .[b[v]] ? .v ? .[h],
                    a = i.idle ? .padding ? .[b[v]] ? .e ? ? !1;
                g.m[S][v] = t || v < 2 ? e : "#a", g.p[S][v] = !m || a || v < 2 ? r : "#a", h++
            }
        }
        return (SR7.E.backend || i.idle ? .boxShadow ? .inuse) && (g.bShdw = {
            use: i.idle ? .boxShadow ? .inuse ? ? !1,
            on: i.idle ? .boxShadow ? .container ? ? "content",
            h: e({
                BII: m,
                o: i.idle ? .boxShadow ? .hoffset ? ? 0,
                def: 0,
                lgdef: "#a",
                rdef: "#a"
            }),
            ...
            spread: e({
                BII: m,
                o: i.idle ? .boxShadow ? .spread ? ? 0,
                def: 0,
                lgdef: "#a",
                rdef: "#a"
            }),
            color: i.idle ? .boxShadow ? .color ? ? "rgba(0,0,0,0.25)"
        }), (SR7.E.backend || "" + (i.hover ? .usehover ? ? !1) != "false") && (g.hov = {
            u: i.hover.usehover ? ? !1,
            m: i.hover.usehovermask ? ? !1,
            zIndex: i.hover.zIndex ? ? "auto",
            deco: i.hover.textDecoration ? ? "none",
            color: {
                c: i.hover.color ? ? "#ffffff",
                bg: _tpt.gradient.convert(i.hover.backgroundColor ? ? "transparent"),
                gAnim: i.hover.gradientStyle ? ? "fading"
            },
            border: {
                c: i.hover.borderColor ? ? "transparent",
                s: i.hover.borderStyle ? ? "none",
                w: {
                    t: e({
                        BII: m,
                        o: i.hover.borderWidth ? .[0] ? ? 0,
                        def: 0,
                        lgdef: "#a",
                        rdef: "#a"
                    }),
            ...
            radius: {
                t: i.hover.borderRadius ? .v ? .[0] ? ? 0,
                r: i.hover.borderRadius ? .v ? .[1] ? ? 0,
                b: i.hover.borderRadius ? .v ? .[2] ? ? 0,
                l: i.hover.borderRadius ? .v ? .[3] ? ? 0
            },
            frame: {
                o: i.hover.opacity ? ? 1,
                oX: i.hover.originX ? ? "50%",
                oY: i.hover.originY ? ? "50%",
                oZ: i.hover.originZ ? ? "50%",
                x: i.hover.x ? ? "inherit",
                y: i.hover.y ? ? "inherit",
                z: i.hover.z ? ? "inherit",
                rZ: 0 == (i.hover.rotationZ ? ? 0) ? "inherit" : i.hover.rotationZ ? ? 0,
                rX: 0 == (i.hover.rotationX ? ? 0) ? "inherit" : i.hover.rotationX ? ? 0,
                rY: 0 == (i.hover.rotationY ? ? 0) ? "inherit" : i.hover.rotationY ? ? 0,
                sX: 1 == (i.hover.scaleX ? ? 1) ? "inherit" : i.hover.scaleX ? ? 1,
                sY: 1 == (i.hover.scaleY ? ? 1) ? "inherit" : i.hover.scaleY ? ? 1,
                skX: i.hover.skewX ? ? 0,
                skY: i.hover.skewY ? ? 0,
                d: i.hover.speed ? ? 300,
                e: "default" == i.hover.ease ? "power1.out" : i.hover.ease ? ? "power1.out"
            },
            filter: {
                g: i.hover.filter ? .grayscale ? ? 0,
                r: i.hover.filter ? .brightness ? ? 100,
                b: i.hover.filter ? .blur ? ? 0
            },
            svg: {
                c: i.hover.svg ? .color ? ? "#ffffff",
                stroke: {
                    c: i.hover.svg ? .strokeColor ? ? "transparent",
                    d: i.hover.svg ? .strokeDashArray ? ? 0,
                    o: i.hover.svg ? .strokeDashOffset ? ? 0,
                    w: i.hover.svg ? .strokeWidth ? ? 0
                }
            }
        }), "text" == g.type && ((SR7.E.backend || i.idle ? .textShadow ? .inuse) && (g.tShdw = {
            use: i.idle ? .textShadow ? .inuse ? ? !1,
            h: _tpt.DNTMtoArr(i.idle ? .textShadow ? .hoffset ? ? 0, 0),
            v: _tpt.DNTMtoArr(i.idle ? .textShadow ? .voffset ? ? 0, 0),
            blur: _tpt.DNTMtoArr(i.idle ? .textShadow ? .blur ? ? 0, 0),
            color: i.idle ? .textShadow ? .color ? ? "rgba(0,0,0,0.25)"
        }), (SR7.E.backend || i.idle ? .textStroke ? .inuse) && (g.tStroke = {
            use: i.idle ? .textStroke ? .inuse ? ? !1,
            w: e({
                BII: m,
                o: i.idle ? .textStroke ? .width ? ? 1,
                def: 1,
                lgdef: "#a",
                rdef: "#a"
            }),
            c: i.idle ? .textStroke ? .color ? ? "rgba(0,0,0,0.25)"
        }), (SR7.E.backend || i.toggle ? .set) && (g.tog = {
            t: i ? .toggle ? .text ? ? "",
            u: i ? .toggle ? .set ? ? !1,
            h: i ? .toggle ? .useHover ? ? !1,
            i: i ? .toggle ? .inverse ? ? !1
        }), g.color = _tpt.DNTMtoArr(i.idle ? .color ? ? "#ffffff", "#ffffff"), g.font = {
            family: i.idle ? .fontFamily ? ? "Roboto",
            style: i.idle ? .fontStyle ? ? !1,
            size: e({
                BII: m,
                o: i.idle ? .fontSize ? ? 20,
                def: 20,
                lgdef: "#a",
                rdef: "#a"
            }),
            weight: _tpt.DNTMtoArr(i.idle ? .fontWeight ? ? 400, 400),
            ls: e({
                BII: m,
                o: i.idle ? .letterSpacing ? ? 0,
                def: 0,
                lgdef: "#a",
                rdef: "#a"
            })
        }), (SR7.E.backend || i.idle ? .spikeUse) && (g.spike = {
            use: i.idle ? .spikeUse ? ? !1,
            l: i.idle ? .spikeLeft ? ? "none",
            r: i.idle ? .spikeRight ? ? "none",
            lw: i.idle ? .spikeLeftWidth ? ? 10,
            rw: i.idle ? .spikeRightWidth ? ? 10
        }), (i.timeline ? .frames ? .frame_1 ? .explodinglayers ? .use || i.timeline ? .frames ? .frame_999 ? .explodinglayers ? .use) && (g.addOns ? ? = {}, g.addOns.explodinglayers ? ? = SR7.migrate.Addon("layer", {
            enabled: !0
        }, "explodinglayers")), "container" != g.type && "text" != g.type || (g.lh = e({
            BII: m,
            o: i.idle ? .lineHeight ? ? 25,
            def: 25,
            lgdef: "#a",
            rdef: "#a"
        })), g.tl = SR7.migrate.timelines({
            dLEN: r,
            o: i,
            type: g.type,
            subtype: g.subtype,
            ouid: i.uid,
            sid: l,
            dtext: g.content ? .text ? ? "",
            global: !!n && {
                s: g.sStart,
                e: g.sEnd
            }
        }), g = SR7.migrate.action(i, g, l)
        ...
        if (e.actions ? .action) {
            ...
            for (let i in e.actions.action) {
                ...
                o.includes("share_") && (l.shr = o.replace("share_", ""), l.shrlink = e.actions.action[i][l.shr + "_link"], l.ltype = "a", l.target = "_blank", SR7.hasSharing = !0);
    ...
    SR7.migrate.layerListUpdate = e => {
        ...
        const d = {};
        let p, c, m = {};
        for (c in t) _tpt.hop(t, c) && ("top" !== t[c].uid && "bottom" !== t[c].uid && "middle" !== t[c].uid && void 0 !== t[c].group && (i.m = Math.max(i.m, t[c].uid), -1 !== (p = t[c].group.puid || ("row" == t[c].type ? "top" : -1)) && (m[p] = !0)), void 0 !== t[c].group && (t[c].group.ptype = "" + (t[c] ? .group ? .puid ? ? -1) == "-1" ? -1 : "row" == t[c].type ? "zone" : "column" == t[c].type ? "row" : t[t[c].group.puid].type));
        ...
        for (let e in a.addOns) {
            ...
            let t = e.replace("revslider-", "").replace("-addon", ""),
                ...
                o = SR7.migrate.Addon("slide_new_layers", r, t, i.m + 1, s);
            void 0 !== o && (d[++i.m] = SR7.D.layerObject({
                id: !1,
                obj: o
            }))
        }
        if (n) {
            let e = "snow",
                t = _tpt.extend({}, n),
                a = SR7.migrate.Addon("slide_new_layers", t, e, i.m + 1, s, r);
            void 0 !== a && (d[++i.m] = SR7.D.layerObject({
                id: !1,
                obj: a
            }))
        }
        if (!0 !== r) {
            ...
            if (e ? .seo ? .set && "front" === (e ? .seo ? .z ? ? "front")) {
                let t = o(i.m + 1);
                t.actions = SR7.migrate.getSEOSlideAction(e.seo), d[++i.m] = SR7.D.layerObject({
                    id: !1,
                    obj: SR7.migrate.LayerObj({
                        o: t,
                        newIDs: i.m,
                ...
                }), d[i.m].zIndex = 150, d[i.m] = SR7.migrate.action(t, d[i.m], s, i.m), "jquery" != t.actions.action[0].link_type && "regular" === t.actions.action[0].type || (d[i.m].cursor = "pointer"), d[i.m].pE = "auto"
            }
            d[++i.m] = SR7.D.layerObject({
                id: !1,
                obj: SR7.migrate.SlideBG(a, i.m, l, s)
            });
            for (let e in a.addOns) {
                if (!_tpt.hop(a.addOns, e)) continue;
                let t = e.replace("revslider-", "").replace("-addon", ""),
                    r = SR7.migrate.Addon("slidebg", a.addOns[e], t);
                void 0 !== r && (d[i.m].addOns ? ? = {}, d[i.m].addOns[t] = r)
            }
        }
        return d
        ...
        let w = SR7.D.splits.indexOf(d) >= 0;
        if ("clip" == d) return R.c = r.clip ? ? [100, 100, "inherit"][n], R.cb = r.clipB ? ? void 0, R;
        if ("mask" == d && 1 == r.use && !0 !== v ? (R.x = e({
                BII: !1,
                o: r.x ? ? [0, 0, "inherit"][n],
                def: [0, 0, "inherit"][n],
                rdef: "#a"
                ...
                def: [0, 0, "inherit"][n],
                rdef: "#a"
            }), R.oflow = g ? "visible" : "hidden") : "mask" == d && (String(_).includes("scene") || "frame_0" !== b && "frame_1" !== b) && (R.oflow = "visible"), void 0 !== u && (R.rep = {
                s: u.s,
                r: u.r ? ? -1,
                sh: u.sh ? ? !0,
                y: u.y ? ? !1,
                c: u.c ? ? !1
            }), l && (r = l, d = "filter"), "content" == d && void 0 !== o && (R.addOns = _tpt.extend({}, o)), "filter" == d ? (R.fu = r.use ? ? !1, R.b = r.blur ? ? 0, R.g = r.grayscale ? ? 0, R.r = r.brightness ? ? 100, R.bu = r.bu ? ? !1, R.bb = r.bb ? ? 0, R.bg = r.bg ? ? 0, R.br = r.br ? ? 100, R.bs = r.bs ? ? 0, R.bi = r.bi ? ? 0) : "loop" == d && void 0 !== r.anchors && void 0 !== r.curv ? (R.anchors = r.anchors, R.curv = r.curv, R.aR = r.aR ? ? !1) : ("content" == d && "frame_999" == b && (R.pE = "n"), !0 !== v && "mask" !== d && (R.x = "loop" !== d || "loop" == d && void 0 !== r.x ? g ? [0, 0, 0, 0, 0] : e({
                BII: !1,
                o: r.x ? ? [0, 0, "inherit"][n],
                def: [0, 0, "inherit"][n],
                rdef: "#a"
            }) : void 0, R.y = "loop" !== d || "loop" == d && void 0 !== r.y ? g ? [0, 0, 0, 0, 0] : e({
                BII: !1,
                o: r.y ? ? [0, 0, "inherit"][n],
                def: [0, 0, "inherit"][n],
                rdef: "#a"
            }) : void 0, R.z = "loop" !== d || "loop" == d && void 0 !== r.z ? g ? 0 : r.z ? ? [0, 0, "inherit"][n] : void 0), "motionpath" !== y && (R = _tpt.extend(R, {
                sX: "loop" !== d || "loop" == d && void 0 !== r.scaleX ? g ? 1 : r.scaleX ? ? [1, 1, "inherit"][n] : void 0,
                sY: "loop" !== d || "loop" == d && void 0 !== r.scaleY ? g ? 1 : r.scaleY ? ? [1, 1, "inherit"][n] : void 0,
                o: "loop" !== d || "loop" == d && void 0 !== r.opacity ? g ? w && "frame_1" == b ? 1 : 0 : r.opacity ? ? (w ? ["inherit", 1, "inherit"][n] : [0, 1, "inherit"][n]) : void 0,
                rX: "loop" !== d || "loop" == d && void 0 !== r.rotationX ? g ? 0 : r.rotationX ? ? [0, 0, "inherit"][n] : void 0,
                rY: "loop" !== d || "loop" == d && void 0 !== r.rotationY ? g ? 0 : r.rotationY ? ? [0, 0, "inherit"][n] : void 0,
                rZ: "loop" !== d || "loop" == d && void 0 !== r.rotationZ ? g ? 0 : r.rotationZ ? ? [0, 0, "inherit"][n] : void 0,
                skX: "loop" !== d || "loop" == d && void 0 !== r.skewX ? r.skewX ? ? [0, 0, "inherit"][n] : void 0,
                skY: "loop" !== d || "loop" == d && void 0 !== r.skewY ? r.skewY ? ? [0, 0, "inherit"][n] : void 0
            }), void 0 !== h && void 0 !== h.effect && (R.fx = (h.effect ? ? "blocktoright").replaceAll("blockto", "c"), R.fxc = h.color ? ? "#ffffff", R.fxe = s, R.fxs = a), void 0 !== m && (R.bgcol = _tpt.gradient.convert(m)), void 0 !== f && (R.col = f), "inherit" == R.o && S.length > 0 && (R.o = S[S.length - 1].o))), "filter" !== d && "loop" !== d) {
            R.xRe = [0, 0, 0, 0, 0], R.yRe = [0, 0, 0, 0, 0], R.off = 0, w && (r.fuse && (R.fu = !0, R.b = r.blur ? ? "0px", R.g = r.grayscale ? ? "0%", R.r = r.brightness ? ? "100%"), R.delay = r.delay ? ? 5, R.dir = SR7.migrate.stgTrans[r.direction ? ? "start"] ? ? r.direction ? ? "start"), R.off = "group" == c || "column" == c ? 1 : 0;
            for (let e = 0; e < 5; e++) w ? R.xRe[e] = R.yRe[e] = 1 : "zone" == c ? (R.xRe[e] = ("" + (R ? .x ? .[e] ? ? "")).includes("%") ? 0 : 2, R.yRe[e] = ("" + (R ? .y ? .[e] ? ? "")).includes("%") ? 0 : 2) : "row" == c ? (R.xRe[e] = ("" + (R ? .x ? .[e] ? ? "")).includes("%") ? 0 : 1, R.yRe[e] = ("" + (R ? .y ? .[e] ? ? "")).includes("%") ? 0 : 1) : (["left", "right"].indexOf(R.x ? .[e] ? ? "") >= 0 && (R.xRe[e] = "group" == c ? 1 : "column" == c ? 4 : 2), ["bottom", "top"].indexOf(R.y ? .[e] ? ? "") >= 0 && (R.yRe[e] = 1))
        }
        if (p)
            for (var x in p) {
                if (!_tpt.hop(p, x) && !p[x]) continue;
                let e;
                if ("content" !== d ? x.includes(d) && (e = x.replace(d, "").toLocaleLowerCase()) : e = x.replace("rotation", "r").replace("skew", "sk"), void 0 !== e)
                    if ("object" == typeof R[e])
                        for (let t = 0; t < 5; t++) "undefined" !== R[e][t] && "inherit" !== R[e][t] && "#a" !== R[e][t] && (R[e][t] = "(" + R[e][t] + ")");
                    else void 0 !== R[e] && "inherit" !== R[e] && "#a" !== R[e] && (R[e] = "(" + R[e] + ")")
            }
        return R
        ...
        if (f.timelines[f.tIndex] = {
            ...
            let e = {};
            for (let r in o.timeline.frameOrder) {
                let a = o.timeline.frameOrder[r].id,
                    i = o.timeline.frames[a];
                for (t of SR7.D.TLTargets) "filter" == t ? (e.filter = e.filter || void 0 !== i.filter && 1 == i.filter.use, (e.filter || i.bfilter && i.bfilter.use) && (i.filter ? ? = {}, void 0 !== i.bfilter && (i.filter.bu = i.bfilter.use ? ? !1, i.filter.bb = i.bfilter.blur, i.filter.bg = i.bfilter.grayscale, i.filter.br = i.bfilter.brightness, i.filter.bs = i.bfilter.sepia, i.filter.bi = i.bfilter.invert), e.filter = !0)) : "clip" == t && 1 == (o.timeline.clipPath ? .use ? ? !1) ? e.clip = !0 : i[t] ? .use && (e[t] = !0)
            }
            if (f = _tpt.extend(f, SR7.migrate.getTimeline({
                    ...
                    sid: d,
                    global: c
                })), r(f), f.oIndex = f.tIndex, o.timeline.loop) {
                f.tIndex = 0;
                let {
                    loop_group_a: e,
                    loop_group_b: t,
        ...
        for (var u = 0; u <= f.tIndex; u++)
            for (t of SR7.D.TLTargets)
                if (void 0 !== f.converted[f.timelines[u].id] ? .[t]) {
                    for (let e in f.converted[f.timelines[u].id][t]) {
                        if ("pers" == e || "orig" == e) continue;
                        let r = f.converted[f.timelines[u].id][t][e];
                        a = r.length;
                        for (let e of ["rX", "rY", "rZ", "skX", "skY", "z", "fb", "sX", "sY"])
                            for (let i = 0; i < a; i++) null !== r[i] && void 0 !== r[i] && (void 0 !== f.dif[t] && 0 == f.dif[t][e] || "inherit" == r[i][e]) && delete r[i][e]
                    }
                    m[f.timelines[u].id] ? ? = {}, m[f.timelines[u].id][t] = SR7.D.layerTLObject(f.converted[f.timelines[u].id][t], t)
                }
        if (m ? .in ? .loop ? .all) {
            let e = m.in.loop.all[2],
                t = m.in.loop.all[3];
            if (e && t) {
                let r = 0;
                ...
                0 == r && delete m.in.loop.all
            }
        }
        if (m ? .in ? .loop ? .filter) {
            let e = m.in.loop.filter ? .[2],
                t = m.in.loop.filter ? .[3];
            if (e && t) {
                let r = 0;
        ...
        t = parseInt(t);
        let m, f, u, g, v, b = r ? .frames ? .frame_1 ? .timeline ? .actionTriggered ? ? !1,
            y = 0;
        ...
        for (let e in r.frameOrder)
            for (u of (m = r.frameOrder[e].id, f = r.frames[m], c && c.e !== c.s && "frame_999" == m && (f.timeline.endWithSlide = !0), !c && "frame_999" == m && "" + (f ? .timeline ? .endWithSlide ? ? void 0) == "true" && parseInt(f.timeline ? .start ? ? t) < t && (f.timeline.endWithSlide = !1), "frame_0" !== m && "frame_1" !== m && "frame_999" !== m && 1 == (f.timeline ? .actionTriggered ? ? !1) ? (v = i.tIndex, i.timelines[++i.tIndex] = {
                    id: "scene_" + i.tIndex,
                    name: "Scene-" + i.tIndex,
                    counter: {}
                }, y = f ? .timeline ? .start ? ? 0) : "frame_999" == m && (v = i.tIndex, i.timelines[++i.tIndex] = {
                    id: "out",
                    name: "out",
                    counter: {}
                }, g = y, y = 0), 0 !== i.tIndex && "out" !== i.timelines[i.tIndex].name && (SR7.migrate.framesToScene[d][n] ? ? = {}, SR7.migrate.framesToScene[d][n][m] = i.timelines[i.tIndex].id), SR7.D.TLTargets)) {
                if (f.content = f.transform, "chars" == u || "words" == u || "lines" == u) {
                    if ("frame_999" !== m && "frame_0" !== m && "frame_1" !== m && void 0 !== f ? .[u] && !S && "false" == String(f[u].use)) continue;
                    if ("frame_0" == m && ("false" == ("" + r.frames.frame_1 ? .[u] ? .use ? ? !0) || null == (r.frames.frame_1 ? .[u] ? ? void 0))) continue;
                    0 == f[u] ? .use && (f[u].delay = 0), S && f[u] && "frame_999" !== m && null == f[u].delay && (f[u].delay = "frame_1" == m ? r.frames ? .frame_0 ? .[u] ? .delay ? ? 5 : "frame_0" == m ? 5 : 0)
                }
                if (void 0 !== l) {
                    if (u !== l) continue
                } else if ("content" !== u && !0 !== a[u]) continue;
                let e = "content" != u && "mask" != u || "frame_0" != m && "frame_1" != m ? "chars" == u || "words" == u || "lines" == u ? f ? .[u] ? .ease ? ? f ? .timeline ? .ease ? ? f ? .ease ? ? "power3.inOut" : f ? .timeline ? .ease ? ? f ? .ease ? ? ("frame_0" == m ? r ? .frames ? .frame_1 ? .timeline ? .ease ? ? "power3.inOut" : "power3.inOut") : r ? .frames ? .frame_1 ? .timeline ? .ease ? ? "power3.inOut";
                i.converted[i.timelines[i.tIndex].id] ? ? = {}, i.converted[i.timelines[i.tIndex].id][u] ? ? = "filter" == u ? {
                    ...
                    all: []
                }, "filter" !== u && (void 0 === f[u] || void 0 !== f[u] && null == f[u].opacity) && ("frame_0" == m && i.zone || "frame_999" == m) && (f[u] ? ? = {}, f[u].opacity = "content" == u && "all" == o && "frame_999" == m ? 0 : 1), i.converted[i.timelines[i.tIndex].id][u][o] ? ? = [];
                let t = i.converted[i.timelines[i.tIndex].id][u][o],
                    n = f ? .timeline ? .speed ? ? 300;
                if ("frame_0" !== m && void 0 !== f.words && "words" == u && "" !== p) {
                ...
                let d, c = "content";
                f ? .color ? .use && (f ? .chars ? .use || f ? .words ? .use || f ? .lines ? .use) && (c = f ? .chars ? .use ? "chars" : f ? .words ? .use ? "words" : "lines");
                window.RVS && SR7.E.resources.explodinglayers;
                (f.explodinglayers && "content" == u && "frame_1" == m || "frame_999" == m && SR7.A ? .explodinglayers ? .getFrameBasics) && (d ? ? = {}, SR7.A ? .explodinglayers && (d.explodinglayers = SR7.A.explodinglayers ? .getFrameBasics(f.explodinglayers, "migrate"))), f.timeline ? .auto && r.frames ? .frame_0 ? .content && (r.frames.frame_0.content.opacity ? ? = 0), "frame_0" !== m && "frame_1" !== m && f.bgcolor ? .use && null == f.bgcolor ? .backgroundColor && void 0 !== h && 1 == h.use && (f.bgcolor.backgroundColor = "transparent"), h = f.bgcolor;
                let _ = "frame_0" == m && b ? "w" + (f ? .timeline ? .start ? ? 0) : "frame_999" == m && f.timeline.endWithSlide ? 0 : (f ? .timeline ? .start ? ? 0) - y;
                "frame_0" != m || b || f ? .timeline ? .start === r ? .frames ? .frame_1 ? .timeline ? .start || void 0 === r ? .frames ? .frame_1 ? .timeline ? .start || (_ = Math.min(parseFloat(f ? .timeline ? .start), parseFloat(r ? .frames ? .frame_1 ? .timeline ? .start)), (null == _ || isNaN(_) || null == _) && (_ = f ? .timeline ? .start ? ? r ? .frames ? .frame_1 ? .timeline ? .start));
                let R = SR7.migrate.transform({
                    trans: f.timeline ? .auto && "frame_999" == m ? "clip" == u ? r.frames.frame_0.content : r.frames.frame_0[u] : "clip" == u ? f.content : f[u],
                    loopfilter: "filter" == o && "loop" == u ? f.filter : void 0,
                    duration: f.timeline ? .auto && !f.timeline ? .actionTriggered && "frame_999" == m ? f.timeline ? .speed ? ? 300 : "frame_0" == m ? 0 : "content" == u || "mask" == u ? f ? .timeline ? .frameLength ? ? f ? .timeline ? .speed ? ? 300 : n,
                    time: _,
                    ease: e,
                    fx: "in" != i.timelines[i.tIndex].id && "out" != i.timelines[i.tIndex].id || "content" != u ? void 0 : "frame_1" == m || "frame_999" == m ? f.sfx : void 0,
                    addOns: d,
                    NRI: "frame_0" === m ? 0 : "frame_1" === m ? 1 : 2,
                    target: u,
                    ...
                    color: "content" != u && u != c || void 0 === f.color || 1 != f.color.use ? void 0 : f.color.color ? ? "#ffffff",
                ...
                if (t.push(R), "frame_999" == m && !f.timeline.endWithSlide && !0 !== f.timeline.actionTriggered) {
                    R.time = (f ? .timeline ? .start ? ? 0) - g;
                    let e = i.converted.in[u][o];
                    e.push(JSON.parse(JSON.stringify(R)));
        ...
        let a = parseInt(e.speed ? ? 1e3) / (e.yoyo || r ? 2 : 1),
            i = {
                ...
                frames: {
                    ...
                    frame_2: SR7.migrate.lpframe(e.frame_999, a, 200 + parseInt(e.start ? ? 300), e.ease)
                },
                tloop: {
                    use: !0,
                    from: "frame_2",
        ...
        return e.curved && t && (i.frames.frame_1.loop.x = 0, i.frames.frame_1.loop.y = 0 - parseInt(e.frame_999.yr ? ? 0) + parseInt(e.frame_999.y ? ? 0), i.frames.frame_2.loop = {
            anchors: [{
                x: 0,
            ...
            curv: e.curviness || 2,
            aR: e.autoRotate || !1
        }, i.tloop.motionpath = !0), (i.frames.frame_1.filter.use || i.frames.frame_2.filter.use) && (i.frames.frame_1.filter.use = i.frames.frame_2.filter.use = !0), i
        ...
        for (let e in a) {
            ...
            if (a[e].target)
                if (Array.isArray(a[e].target))
                    for (let t in a[e].target)("" + a[e].target[t]).includes("sta") ? a[e].target[t] = r + "-" + a[e].target[t].replace("sta_", "") : a[e].target[t] = "callSlide" == a[e].a || "open_modal" == a[e].a ? SR7.D.fixSR6IDs(a[e].target[t]) : a[e].target[t];
            ...
            for (let e = 0; e < a.length; e++)
                for (let r of ["sc", "scm", "scn"]) {
                    ...
                    if ("string" == typeof i && i.includes("frame_")) {
                        ...
                        do {
                            o = l(i, a[e].target, t, s), s++
                        } while ((void 0 === o || o === i) && s < n);
                        void 0 !== o && o !== i && (a[e][r] = o)
                    }
                }
        }
        ...
        if (null != e && "object" == typeof e && null != e.detail) {
            ...
            try {
                ...
                SR7.hasSharing && (i.settings.addOns ? ? = {}, i.settings.addOns.sharing = {
                    u: !0
                ...
                e.detail.info && void 0 !== window.RVS && (void 0 !== RVS.S.migrationError && (RVS.S.migrationError++, e.detail.info.innerHTML = "Migration Error", SR7.E.backend = !0, RVS.F.ajaxRequest("set_v7_migration_failed", {
                    id: e.detail.id,
