    ...
    [313], {
        ...
        3991: (e, t, n) => {
            ...
            r({
                ...
                map: function map(e) {
                    ...
                    return g ? o(g, this, e) : new v(a(this), {
                        mapper: e
                    })
                }
            })
            ...
            t.default = class SwiperHandler {
                ...
                adjustConfig(e) {
                    ...
                    return Object.keys(e.breakpoints).forEach(r => {
                        ...
                        e.breakpoints[i] = e.breakpoints[r], e.breakpoints[r] = {
            ...
            e.exports = function() {
                ...
                function _removeHook(e, t, r, o) {
                    ...
                    if (n[e][t])
                        if (r)
                            if (i = n[e][t], o)
                                for (a = i.length; a--;)(s = i[a]).callback === r && s.context === o && i.splice(a, 1);
                            else
                                for (a = i.length; a--;) i[a].callback === r && i.splice(a, 1);
                    else n[e][t] = []
                }
                ...
                function _runHook(e, t, r) {
                    ...
                    if (i = s.length, "filters" === e)
                        ...
                        for (o = 0; o < i; o++) s[o].callback.apply(s[o].context, r);
        ...
        7248: (e, t, n) => {
            ...
            e.exports = function(e) {
                ...
                this.addHandler = function(t, n) {
                    ...
                    const s = new t(n);
                    elementorFrontend.hooks.doAction(`frontend/element_handler_ready/${n.elementName}`, n.$element, e), o && (r[o][i] = s)
        ...
        7603: (e, t, n) => {
            ...
            class Frontend extends elementorModules.ViewModule {
                ...
                addUserAgentClasses() {
                    for (const [e, t] of Object.entries(s.default)) t && this.elements.$body.addClass("e--ua-" + e)
                }
                setDeviceModeData() {
